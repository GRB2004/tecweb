...
$(document).on('click', '.product-delete', function () {
    ...
    $(document).on('click', '.product-item', function() {
        ...
        // Cambiar POST por GET y usar la nueva ruta con el ID en la URL
        $.get(`http://localhost/tecweb/practicas/actividades/a09/product_app/backend/product/${id}`, function(product) {
            ...
            edit = true;
            console.log(edit);
        }).fail(function(jqXHR, textStatus, errorThrown) { // Manejar errores
